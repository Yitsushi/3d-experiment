...
namespace Graphics {
    ...
    void VertexBufferStore::Add(const char * name, int layout, std::vector<glm::vec2> data) {
        ...
        glBindBuffer(GL_ARRAY_BUFFER, vertex_buffers[name]);
        glVertexAttribPointer(layout, sizeof(glm::vec2) / sizeof(GLfloat), GL_FLOAT, GL_FALSE, 0, (void*)0);
    }
